...
class GetAllVacanciesUsecase extends UsecaseWithoutParams<List<VacancyEntity>> {
  final JobsRepository repository;

  GetAllVacanciesUsecase(this.repository);

  @override
  ResultFuture<List<VacancyEntity>> call() async {
    return await repository.getAllVacancies();
  }
}
