...
class UserProfileEntity extends Equatable{
  ...
  List<Object?> get props => [contacts,userID, name,email, phone,dateTime,signedIn,choice,appleID,role,provider,defaultContact,defaultContactId,specializations, specializationsNorm,birthDate, education,about, workExperience,age, isFavorite];
}
