...
import 'package:mama_kris/features/employe_welcome/presentations/widgets/employe_auth_bottomsheet.dart';
import 'package:mama_kris/features/employe_welcome/presentations/widgets/job_terms_bottomsheet.dart';

class WelcomeEmployePage extends StatefulWidget {
  const WelcomeEmployePage({super.key});

  @override
  State<WelcomeEmployePage> createState() => _WelcomeEmployePageState();
}

class _WelcomeEmployePageState extends State<WelcomeEmployePage> {
                      ...
                      isSecondaryPrimary: true,
                        ...
                        onTap: () {
                          ...
                          if (option == _WelcomeOption.register) {
                            employeTermBottomsheet(context, false, true, () {
                              EmployeAuthBottomsheet.emailBottomSheet(
                                context,
                              );
                            });
                            // jobTermsBottomSheet(context, false, false, () {});
                          } else {
                            EmployeAuthBottomsheet.loginBottomSheet(
                              context,
