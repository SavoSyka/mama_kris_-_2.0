...
import 'package:mama_kris/screens/scammers_screen.dart';
...
void showScammersSheet(BuildContext context) {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Описание
                      Text(
                        "Удалённая работа открывает возможности, но также привлекает мошенников. Наша команда HR-менеджеров отбирает вакансии, но не может гарантировать полную безопасность. Вот несколько советов для вашей защиты:\n\n"
                        "1. Будьте скептичны к слишком хорошим предложениям: высокая зарплата за минимальные усилия может быть уловкой мошенников.\n"
                        "2. Не платите за работу: легитимные работодатели не требуют денег за трудоустройство.\n"
                        "3. Не сообщайте пароли и конфиденциальную информацию: защищайте свои аккаунты и личные данные.\n"
                        "4. Осторожно относитесь к финансовым просьбам: если работодатель просит перевести деньги, это признак мошенничества.\n"
                        "5. Не отправляйте оригиналы документов: достаточно копий.\n\n"
                        "Мы стараемся минимизировать риски, но ответственность за работодателей несем. Будьте внимательны и осторожны!",
                        style: TextStyle(
                          fontFamily: 'Jost',
